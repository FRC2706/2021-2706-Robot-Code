...
public class RamseteCommandRio extends CommandBase {
     ...
     */
    public RamseteCommandRio(Trajectory trajectory, String loggingDataIdentifier) {
        ...
        m_leftController = new PIDController(Config.RAMSETE_KP, 0, 0);
        m_rightController = new PIDController(Config.RAMSETE_KP, 0, 0);
